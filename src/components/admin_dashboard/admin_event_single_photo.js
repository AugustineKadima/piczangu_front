...
export default function AdminEventSinglePhoto(){
    return (
        <div>
                ...
                <div className="find_photographer_wrapper">
                    <div className="find_photographer_content_container">
                        ...
                        <div className="top_event_nav">
                            <NavLink to="/admin/events"><h4>All Events</h4></NavLink>
                            <NavLink to="/admin/events/photos"><h4 id="event_para_two">Event Photos</h4></NavLink>
